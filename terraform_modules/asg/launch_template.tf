...
resource "aws_launch_template" "blue_launch_template" {
  ...
  user_data = base64encode(file("/home/tluz/project/online_marketplace_infrastructure/terraform_modules/asg/userdata_blue_${var.app}_${var.environment}.sh"))
}
...
resource "aws_launch_template" "green_launch_template" {
  ...
  user_data = base64encode(file("/home/tluz/project/online_marketplace_infrastructure/terraform_modules/asg/userdata_green_${var.app}_${var.environment}.sh"))
}